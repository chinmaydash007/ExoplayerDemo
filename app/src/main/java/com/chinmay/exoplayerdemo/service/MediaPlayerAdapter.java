...
public class MediaPlayerAdapter extends PlayerAdapter {
    ...
    private void playFile(MediaMetadataCompat metaData) {
        ...
        try {
            ...
            HlsMediaSource.Factory hlsMediaSource = new HlsMediaSource.Factory(mDataSourceFactory);
            HlsMediaSource mediaSource = hlsMediaSource.createMediaSource(Uri.parse(metaData.getString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI)));
            //this is for simple file format.
